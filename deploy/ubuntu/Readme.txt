On-premises CliniDeID installation instructions for Ubuntu 20.04.2
...
1) Create a swap file with the command:
	sudo fallocate -l 28G /swapfileNew
...
You may need to edit /etc/fstab to make the changes automatic on a reboot:
	 sudo nano /etc/fstab
then add the following line at the end of the file:
/swapfileNew    none    swap    sw      0       0
