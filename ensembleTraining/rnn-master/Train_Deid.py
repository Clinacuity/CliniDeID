...
######################################################
datasets = {
    'uni':                                   #Name of the dataset
        {'columns': {0:'tokens', 6:'NER_BIO'},   #CoNLL format for the input data. Column 0 contains tokens, column 2 contains POS and column 2 contains chunk information using BIO encoding
...
#model.storeResults('results/deid.csv') #Path to store performance scores for dev / test
